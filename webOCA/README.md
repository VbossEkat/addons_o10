...
V[web_advanced_search_x2x](web_advanced_search_x2x/) | 10.0.1.0.0 | Use a search widget in advanced search for x2x fields
V*[web_chatter_paste](web_chatter_paste/) | 10.0.1.0.0 | Paste images and drop files into the chatter and upload them directly
[web_confirm_window_close](web_confirm_window_close/) | 10.0.1.0.0 | Check for unsaved data when closing browser window
V*[web_dialog_size](web_dialog_size/) | 10.0.1.0.0 | A module that lets the user expand a dialog box to the full screen width.
V*[web_editor_background_color](web_editor_background_color/) | 10.0.1.0.0 | Set any background color for web editor snippets
V*[web_environment_ribbon](web_environment_ribbon/) | 10.0.1.0.0 | Web Environment Ribbon
V[web_export_view](web_export_view/) | 10.0.1.0.0 | Web Export Current View
V*[web_favicon](web_favicon/) | 10.0.1.0.0 | Allows to set a custom shortcut icon (aka favicon)
...
V[web_no_bubble](web_no_bubble/) | 10.0.1.0.0 | Remove the bubbles from the web interface
[web_notify](web_notify/) | 10.0.1.0.0 | Send notification messages to user
V****[web_responsive](web_responsive/) | 10.0.1.0.0 | It provides a mobile compliant interface for Odoo Community web
V*[web_search_with_and](web_search_with_and/) | 10.0.1.0.0 | Use AND conditions on omnibar search
V*[web_searchbar_full_width](web_searchbar_full_width/) | 10.0.1.0.0 | Show search bar in full screen width
+[web_send_message_popup](web_send_message_popup/) | 10.0.1.0.0 | Web Send Message as Popup
V*[web_sheet_full_width](web_sheet_full_width/) | 10.0.1.0.1 | Use the whole available screen width when displaying sheets
V[web_shortcut](web_shortcut/) | 10.0.1.0.0 | Shortcut Menu
V[web_timeline](web_timeline/) | 10.0.1.0.0 | Interactive visualization chart to show events in time
...
V[web_widget_image_download](web_widget_image_download/) | 10.0.1.0.0 | Allows to download any image from its widget
V+[web_widget_image_webcam](web_widget_image_webcam/) | 10.0.1.0.0 | Allows to take image with WebCam
